...
class Certification(models.Model):
    ...
    description = models.TextField(blank=True)          # ✅ جديد
    date_obtained = models.DateField(blank=True, null=True)
    expiry_date = models.DateField(blank=True, null=True)
    order = models.IntegerField(default=0)              # ✅ جديد
...
class WorkResponsibility(models.Model):
    experience = models.ForeignKey(
        WorkExperience, on_delete=models.CASCADE, related_name='responsibilities'
    )
...
class Project(models.Model):
    ...
    icon_class = models.CharField(
        max_length=100, help_text="FontAwesome icon class", default="fas fa-code"
    )
    image = models.ImageField(upload_to='projects/', blank=True, null=True)  # ✅ جديد
    url = models.URLField(blank=True, help_text="GitHub or live project URL")  # ✅ جديد
    is_featured = models.BooleanField(default=True)                           # ✅ جديد
    order = models.IntegerField(default=0)                                    # ✅ جديد
...
class Quote(models.Model):                                                    # ✅ جديد كامل
    ...
    is_active = models.BooleanField(default=True, help_text="Show this quote on the site")
